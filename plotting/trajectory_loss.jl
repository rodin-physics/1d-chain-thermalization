...
data_att = load_object("data/Non_Thermal/Single_σ0[220]_σdot0[50]_MemInf_λ4_Φ-8_μ1_d300_bias0.0_ΩTnothing_τ100.jld2")
...
## Computation
(rep_xs, rep_ys) = Δ_traj2(data_rep)
(att_xs, att_ys) = Δ_traj2(data_att)

# (rep_xs2, rep_ys2) = Δ_traj(data_rep2)
# (att_xs2, att_ys2) = Δ_traj(data_att2)

σ_dots = range(10, 70, length=100)
