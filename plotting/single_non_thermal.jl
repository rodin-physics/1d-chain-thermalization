...
data = load_object(
    "data/non_thermal/Single_σ0[45]_σdot0[20]_MemInf_λ0.5_Φ1_μ1_d60_ΩTnothing_τ100.jld2",
)
...
data = load_object(
    "data/non_thermal/Single_σ0[45]_σdot0[20]_MemInf_λ0.5_Φ-1_μ1_d60_ΩTnothing_τ100.jld2",
)
δ = data.τs[2] - data.τs[1]
τ_max = 105
idx = findall(data.τs .< τ_max)
